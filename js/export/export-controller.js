import { graphicToGeoJSONFeature, safeExportName } from "./export-core.js?v=0.13.1";
...
export class ExportController {
  ...
  async exportLayer({ uid, scope = "filtered", fileName, format = "geojson" } = {}) {
    ...
    const worker = new Worker(new URL("./export-worker.js?v=0.13.1", import.meta.url), { type: "module" });
