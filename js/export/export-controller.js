import { graphicToGeoJSONFeature, safeExportName } from "./export-core.js?v=0.14.0";
...
export class ExportController {
  ...
  async exportLayer({ uid, scope = "filtered", fileName, format = "geojson" } = {}) {
    ...
    const worker = new Worker(new URL("./export-worker.js?v=0.14.0", import.meta.url), { type: "module" });
